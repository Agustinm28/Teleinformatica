...
def network():
    ...
    # Rutas: 
    # - Subred 10.0.2.0/24 a través del router 192.168.100.9 
    # - Subred 10.0.1.0/24 a través del router 192.168.100.1 
    ...
    # - Subred 10.0.2.0/24 a través del router 192.168.100.6 
    # - Subred 192.168.100.8/29 a través del router 192.168.100.6 
    r1.cmd('sysctl net.ipv4.ip_forward=1')
    r1_cmd = 'ip route add 10.0.2.0/24 via 192.168.100.6 && \
               ip route add 192.168.100.8/29 via 192.168.100.6'
    r1.cmd(r1_cmd)

    # - Subred 10.0.1.0/24 a través del router 192.168.100.14
    # - Subred 192.168.100.0/29 a través del router 192.168.100.14
